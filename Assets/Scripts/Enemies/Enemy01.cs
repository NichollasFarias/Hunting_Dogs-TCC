...
public class Enemy01 : MonoBehaviour
{
    ...
    void FixedUpdate()
    {
        ...
        else
        {
            ...
            //Detect close left
            if (player.transform.position.x > transform.position.x && player.transform.position.x - transform.position.x < 0.72f && detecting.Life > 0)
            {
                Close = true;
                Walking = false;
            }
            ...
            //Detect far left
            if (player.transform.position.x > transform.position.x && player.transform.position.x - transform.position.x < 8f && player.transform.position.x - transform.position.x > 0.7f && detecting.Life > 0)
            {
                Close = false;
            }

            //Detect far right
            else if (player.transform.position.x < transform.position.x && player.transform.position.x - transform.position.x > -8f && player.transform.position.x - transform.position.x < -0.7f && detecting.Life > 0)
            {
                Close = false;
            }
            #endregion
            ...
            //Right Walk
            if (player.transform.position.x > transform.position.x && player.transform.position.x - transform.position.x < 4f && Close == false && Life.Lifes > 0 && detecting.Life > 0)
            {
            ...
            //Left Walk
            else if (player.transform.position.x < transform.position.x && player.transform.position.x - transform.position.x > -4f && Close == false && Life.Lifes > 0 && detecting.Life > 0)
            {
                transform.Translate(-Speed * (Time.timeScale * Time.deltaTime), 0, 0 * Time.deltaTime);
                anim.SetInteger("Speed", 1);
                Idle = false;
                Walking = true;
                AttackTimer += Time.deltaTime;
